...
{The different parameters that can be configured are separated by application configuration parameters and project configuration parameters. The application configuration parameters have the same value for all projects. For now, it only includes the installation directory of GRASP algotithm.\\ 
