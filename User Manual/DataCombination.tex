...
When a configuration is selected, by clicking the "Send ata" button, the SendFiles script is executed. If the script is executed successfully, the corresponding messages will be shown in Ouput and Logging tabs, as it can be seen in the following example in \Cref{fig:ExecuteSendData}.\smallskip\\
If .sdat file and .yml has been written successfully, GRASP algorithm will be executed automatically.\smallskip\\
\begin{figure}[H]
\centering
