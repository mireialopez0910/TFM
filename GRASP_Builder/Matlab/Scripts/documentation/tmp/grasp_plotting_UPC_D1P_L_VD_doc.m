%% [GRASP_Plot_Correctly] = grasp_plotting_UPC_D1P_L_VD(path2file, Lambda,Waves_AERONET2,size_binsF,size_binsC)
%
%% Descripció
%
% Realitza els c&agrave;lculs necessaris per a representar gr&agrave;ficament els productes derivats del GRASP.
% Concretament, aquesta versió és responsable de la configuració D1_lL (Lidar i fotòmetre sense informació de polarització).
%
