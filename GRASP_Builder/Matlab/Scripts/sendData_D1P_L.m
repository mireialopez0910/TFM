...
%! de la mesura que inclou dades sense despolarització del LIDAR i dades amb
%! polarització del fotòmetre perquè la funció WriteFiles_preGARRLiC_D1P_L()
...
%!
    ...
    try
        ...
        if isFigure == true
            figure(1)
            plot(RCS1064*100000, Range1064, '-r'), hold on
            plot(RCS355, Range355, '-b')
            plot(RCS532, Range532, '-g'), hold off
        ...
        %!
        fullFileName = fullfile(URL_output, ['GRASP_', location,'_', NombreEntrada2, '_D1P_L']);
        ...
        %! 1064 / 532 / 355 (altitude, backscatter) i es guarden en el fitxer GRASP_RC.
        %!
        %! Nota: Aquesta part s'ha mogut des de 'elda_profile.m per motius de
        %! unificació de dades en el fitxer GRASP_RC
        %!
        %! *Dades a recuperar:*
        %!
        ...
        try
            ...
            logMessage(['ERROR Creating ELDA Profile for _1064_', ME.message]);
        end
        ...
        try
            ...
            logMessage(['ERROR Creating ELDA Profile for _0532_', ME.message]);
        end
        ...
        AOD1640 = T1.AOD_1640nm(Ind); 
        AOD1020 = T1.AOD_1020nm(Ind); 
        AOD870 = T1.AOD_870nm(Ind);
        AOD675 = T1.AOD_675nm(Ind);
        AOD500 = T1.AOD_500nm(Ind); 
        AOD440 = T1.AOD_440nm(Ind); 
        AOD380 = T1.AOD_380nm(Ind);
        ...
        rad3801 = T2{Index380,51:77};
        rad4401 = T2{Index440,51:77};
        rad5001 = T2{Index500,51:77};
        rad6751 = T2{Index675,51:77};
        rad8701 = T2{Index870,51:77};
        rad10201 = T2{Index1020,51:77};
        rad16401 = T2{Index1640,51:77};
        ...
        %%% EN ESTA CONFIGURACIÓN NO HACE NADA CON EL FLIP. Se adjunta versión
        %%% D1_L
        %%% rad1640 = T2{Index1640,23:49}; rad1640 = [rad1640;fliplr(T2{Index1640,51:77})]; mrad1640 = mean(rad1640);
        %%
    
        rad380 = [T2{Index380,23:49};fliplr(T2{Index380,51:77})]; mrad380 = mean(rad380);
        rad440 = [T2{Index440,23:49};fliplr(T2{Index440,51:77})]; mrad440 = mean(rad440);
        rad500 = [T2{Index500,23:49};fliplr(T2{Index500,51:77})]; mrad500 = mean(rad500);
        rad675 = [T2{Index675,23:49};fliplr(T2{Index675,51:77})]; mrad675 = mean(rad675);
        rad870 = [T2{Index870,23:49};fliplr(T2{Index870,51:77})]; mrad870 = mean(rad870);
        rad1020 = [T2{Index1020,23:49};fliplr(T2{Index1020,51:77})]; mrad1020 = mean(rad1020);
        rad1640 = [T2{Index1640,23:49};fliplr(T2{Index1640,51:77})]; mrad1640 = mean(rad1640);
    ...
    for c = 1:length(SAA0)
        ...
        %! de la Terra al Sol
        %DayAngle=((DayOftheYear-1)*360)/(365*(pi/180));% Platform DIVA
        ...
        %! |WriteFiles_preGARRLiC_D1P_L(...)| encarregada d'escriure el fitxer
        %! de sortida SDAT. Si s'escriu correctament retornarà el nom
        %! de l'arxiu creat.
    [GARRLiC_file_name] = WriteFiles_preGARRLiC_D1P_L(measureID, URL_output, latitude,longitude,ground_height,SZA380,SZA440,SZA500,...
        ...
        PAA440,mDOLP440aer,PAA380,mDOLP380aer,Rangelog,RCS355log,RCS532log,RCS1064log,NombreEntrada1,NombreEntrada2);
