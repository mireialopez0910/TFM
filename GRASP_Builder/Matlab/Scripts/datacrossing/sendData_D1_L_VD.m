...
%!
    ...
    try
        ...
        %!
        fullFileName = fullfile(URL_output, ['GRASP_', location, '_', NombreEntrada2, '_D1_L_VD']);
        save(fullFileName,'Range532', 'RCS532', 'RangeVD532', 'VD532', 'AltB532', 'B532', 'Range355', 'RCS355', 'RangeVD355', 'VD355', 'AltB355', 'B355', 'Range1064', 'RCS1064');
        ...
        try
            ...
            logMessage('Save file to: ');
            logMessage(fullFileName)
        ...
        if isFigure == true
            ...
            ax(2) = nexttile;
            plot(B355,AltB355,B532,AltB532,B1064,AltB1064)
            legend('355 nm','532 nm','1064 nm','Location','northwest')
            legend('boxoff')
            ylabel('Height')
            xlabel('Backs.')
        ...
        save(fullFileName,'-append', 'Rangelog','RCS1064log','RCS532log','RCS355log','heightMax','heightMin','NombreEntrada2')
        ...
        %! de l'arxiu creat.
        [GARRLiC_file_name] = WriteFiles_preGARRLiC_D1_L_VD(measureID, URL_output, latitude,longitude,ground_height,SZA380,SZA440,SZA500,...
            SZA675,SZA870,SZA1020,SZA1640,SAA380,SAA440,SAA500,SAA675,SAA870,SAA1020,SAA1640,AOD380,nRadiance380,...
            AOD440,nRadiance440,AOD500,nRadiance500,AOD675,nRadiance675,AOD870,nRadiance870,AOD1020,nRadiance1020,...
            AOD1640,nRadiance1640,Rangelog,nRCS355log,nRCS532log,nRCS1064log,VD355log,VD532log,NombreEntrada1,NombreEntrada2);
