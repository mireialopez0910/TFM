...
% Si se li ha passat el par&agrave;metre |isFigure = *True*| la funció representar&agrave; algunes gr&agrave;fiques que permeten analitzar les dades carregades
% Per exemple, gr&agrave;fiques amb RCS1064, RCS355 i RCS532
%% GRASP Range
