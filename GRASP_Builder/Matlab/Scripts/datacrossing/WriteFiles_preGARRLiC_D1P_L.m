...
%--------------------------------------------------------------------------------------------------------------------------
    ...
    try
        ...
        fprintf(fichero_GARRLiC,'1 3 3 3 1 3 3 3 1 3/r\n');
        fprintf(fichero_GARRLiC,'31 12 41 46 12 41 46 12 41 46 31 12 41 46 12 41 46 12 41 46 31 12 41 46/r\n');
        fprintf(fichero_GARRLiC,'%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t%d/t/r\n',m,k,n380,P380,k,n440,P440,k,n500,P500,m,k,n675,P675,k,n870,P870,k,n1020,P1020,m,k,n1640,P1640);
        ...
        for i=1:1:m-1
            fprintf(fichero_GARRLiC,'%f/t',Range355(i));
        end
        ...
        % Height at 532 nm
        for i=1:1:m-1
            fprintf(fichero_GARRLiC,'%f/t',Range532(i));
        end
        fprintf(fichero_GARRLiC,'%f/r\n',Range532(m));
        ...
        % Height at 1064 nm
        for i=1:1:m-1
            fprintf(fichero_GARRLiC,'%f/t',Range1064(i));
        end
        fprintf(fichero_GARRLiC,'%f/r\n',Range1064(m));
        ...
        fprintf(fichero_GARRLiC,'0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/r\n');
        fprintf(fichero_GARRLiC,'0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/t0/r\n');
