...
\end{figure}
Thanks to this, it is not necessary to compile the full project in order to modify the scripts or configuration files. If any modification of these files is needed, it can be directly accessed and modified. These scripts can be also compiled with Matlab without the need of executing the full application, but it is needed to configure different parameters, depending on the different scripts.
