...
\subsection{MVVM}
{
  ...
  \begin{figure}[H]
    ...
    \caption[mvvm]{\footnotesize{MVVM design pattern}}
    \label{fig:mvvm}
  \end{figure}
...
These principles are:}
  ...
  {
    Statets that \textit{a class should have only one reason to change}, meaning that it should have only one responsibility, job or purpose within the softwar project.\smallskip\\
...
\begin{figure}[h]
    ...
    \caption[mvvm]{\footnotesize{MVVM design pattern applied to the project architecure}}
