...
\begin{enumerate}
    ...
    \item Test different dates with problematic scenarios: After checking the full execution of the applications, it was needed to test the application with negative tests. Negative test consist on testing the software in known and problematic scenarios, in order to check if the application is able to handle them correctly. The full testing results table can be found in Appendix \ref{ap:test_results}. The main cases checked were:
    \begin{itemize}
        \item 
    \end{itemize}
\end{enumerate}
